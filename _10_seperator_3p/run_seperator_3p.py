...
def main():
    ...
    f = Reader("./templates/_10_seperator_3p/seperator_3p.sql")
    sql = f.text
    ...
    fname = "(AGG) 3P Mixed And Only {0}년 {1}월 {2} {3} LJS.xlsx".format(y_prev, m_prev, now_history_day, now_history_time)
