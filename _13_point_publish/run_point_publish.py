...
def main():
    ...
    f = Reader("./templates/_13_point_publish/point_publish.sql")
    sql = f.text
    ...
    fname = "(RAW) CD Published Points {0}년 {1}월 {2} {3} LJS.xlsx".format(y_prev, m_prev, now_history_day, now_history_time)
